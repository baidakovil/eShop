...
```powershell
metricsreporter read --namespace <given_namespace> --metric OpenCoverCyclomaticComplexity --symbol-kind Any
```
...
```powershell
metricsreporter test --symbol <symbol_been_refactored> --metric OpenCoverCyclomaticComplexity
```
